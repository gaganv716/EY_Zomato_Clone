...
import Restaurantlist from "../../pages/Restaurant/Restaurantlist"; // Import the new RestaurantList component
import "./Homepage.css";
...
const Homepage = () => {
  ...
  return (
    <div className="homepage">
      <Navbar isAuthenticated={isAuthenticated} isHomepage={true} />
      ...
      <section className="restaurants-section">
        ...
        <Restaurantlist /> {/* Render the RestaurantList component here */}
      </section>
